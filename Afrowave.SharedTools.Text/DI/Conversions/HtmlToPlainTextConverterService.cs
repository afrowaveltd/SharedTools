...
{
	/// <summary>
	/// Service implementation that converts HTML to plain text.
	/// </summary>
	public class HtmlToPlainTextConverterService : IHtmlToPlainTextConverterService
	{
			...
			for(int i = 0; i < html.Length; i++)
			{
				...
				if(inTag)
				{
					if(c == '>')
					{
						...
						{
							inAnchor = true;
							int hrefIndex = tag.IndexOf("href=", System.StringComparison.OrdinalIgnoreCase);
