...
{
	/// <summary>
	/// Converts HTML to Markdown using tag mapping. DI variant.
	/// </summary>
	public class HtmlToMarkdownConverterService : IHtmlToMarkdownConverterService
	{
		public string Convert(string html, List<MarkdownTagMapping> mappings)
		{
		...
		public async Task ConvertStreamAsync(TextReader input, TextWriter output, List<MarkdownTagMapping> mappings, CancellationToken cancellationToken = default)
		{
