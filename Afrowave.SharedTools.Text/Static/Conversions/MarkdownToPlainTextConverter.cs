...
{
	public static class MarkdownToPlainTextConverter
	{
		public static string Convert(string markdown)
		{
			...
			// 5. Tabulky – pokročilé zarovnání bloků
			...
			// 6. Odrážky, seznamy – zachovat
			// (ponecháváme "- " a "1. " na začátku řádku)

			// 7. Tučné/kurzíva/underline a další markdown tagy – odstranit hvězdičky/podtržítka/tilde
		...
		public static async Task ConvertStreamAsync(TextReader input, TextWriter output, CancellationToken cancellationToken = default)
		{
			var sb = new StringBuilder();
