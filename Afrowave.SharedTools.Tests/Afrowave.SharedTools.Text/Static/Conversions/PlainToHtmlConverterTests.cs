...
{
	public class PlainToHtmlConverterTests
	{
		[Fact]
		public void Convert_SimpleParagraph_ShouldWrapInParagraphTags()
		{
			var input = "Hello world!";
			var html = PlainToHtmlConverter.Convert(input);
		...
		{
			var html = PlainToHtmlConverter.Convert("");
		...
		{
			var input = "Line1\nLine2";
			var html = PlainToHtmlConverter.Convert(input, minify: true);
